...
if args.l >= 13.5 and args.l <= 25.5 and args.f <= 55.0 and args.f >= 48.9:
    ...
    print(f"Wyniki_z_transformacji_flh2xyz; X92 = {x92:^.3f}[m], Y92 = {y92:^.3f}[m], X00 = {x00:^.3f}[m], Y00 = {y00:^.3f}[m]")
else:
    x92 = " '-' " 
    y92 = " '-' " 
    x00 = " '-' " 
    y00 = " '-' " 
    print(f"Wyniki_z_transformacji_flh2xyz(to położenie nie jest obsługiwane przez nie jest obsługiwany przez układ współrzędnych płaskich PL1992 i PL2000)); X92 = {x92}[m], Y92 = {y92}[m], X00 = {x00}[m], Y00 = {y00}[m]")
